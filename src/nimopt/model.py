...
class Model:
    ...
    def var(
        ...
        generator = self._generator_of(name)
        if generator is not None:
            raise ValueError(
                f"variable {name!r} is generated by piecewise {generator!r}; "
    ...
    def constraint(
        ...
        if generator is not None:
            raise ValueError(
                f"constraint {name!r} is generated by piecewise {generator!r}; "
                f"declare another name"
            )
    ...
    def _generator_of(self, name: str) -> str | None:
        """Return the piecewise declaration that generated `name`."""
        for held, declaration in self.piecewise_declarations.items():
            if name in declaration.generated_names():
                return held
        return None
